...
var semigroupHashSet = function (dictHashable) {
    return Data_HashMap.semigroupHashMap(dictHashable);
};
var monoidHashSet = function (dictHashable) {
    return Data_HashMap.monoidHashMap(dictHashable);
};
...
var fromArray = function (dictHashable) {
    var $65 = Data_HashMap.fromArrayBy(dictHashable)(Control_Category.identity(Control_Category.categoryFn))(Data_Function["const"](Data_Unit.unit));
    return function ($66) {
        return HashSet($65($66));
    };
};
    ...
    return function (f) {
        return Data_Foldable.foldr(foldableHashSet)(function (a) {
            return function (s) {
                ...
                throw new Error("Failed pattern match at Data.HashSet (line 115, column 18 - line 117, column 33): " + [ v.constructor.name ]);
            };
        })(empty);
    };
};
