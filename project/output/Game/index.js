...
var _y = function (dictStrong) {
    ...
    var $40 = Data_Lens_Record_Newtype["_f"](new Data_Symbol.IsSymbol(function () {
        return "y";
...
var _x = function (dictStrong) {
    var $42 = Data_Lens_Record_Newtype.field(new Data_Symbol.IsSymbol(function () {
        return "player";
    }))(newtypeGameState)(newtypeGameState)()()(Data_Symbol.SProxy.value)(dictStrong);
    var $43 = Data_Lens_Record_Newtype.field(new Data_Symbol.IsSymbol(function () {
        return "position";
    }))(newtypePlayer)(newtypePlayer)()()(Data_Symbol.SProxy.value)(dictStrong);
    var $44 = Data_Lens_Record_Newtype.field(new Data_Symbol.IsSymbol(function () {
        return "x";
    }))(newtypePosition)(newtypePosition)()()(Data_Symbol.SProxy.value)(dictStrong);
    return function ($45) {
        return $42($43($44($45)));
    };
};
var _runSpeed = function (dictStrong) {
    var $46 = Data_Lens_Record_Newtype["_f"](new Data_Symbol.IsSymbol(function () {
        return "player";
    }))(newtypeGameState)(newtypeGameState)()()(Data_Lens_Record_Newtype.l)(dictStrong);
    var $47 = Data_Lens_Record_Newtype["_f"](new Data_Symbol.IsSymbol(function () {
        return "runSpeed";
    }))(newtypePlayer)(newtypePlayer)()()(Data_Lens_Record_Newtype.l)(dictStrong);
    return function ($48) {
        return $46($47($48));
...
var runSpeedGet = Data_Lens_Getter.view(_runSpeed(Data_Lens_Internal_Forget.strongForget));
